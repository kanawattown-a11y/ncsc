...
import { Shield, Search, Database, Users, ShieldAlert, Trash2, MessageSquare } from "lucide-react";
...
export default function Sidebar() {
  ...
  const getLinks = () => {
    ...
    if (role === "ADMIN") {
      ...
      links.push({ name: "المراقبة وسجلات النشاط", href: "/dashboard/admin/logs", icon: ShieldAlert });
